...
export function HeroSection() {
  ...
  return (
    <>
      <section className="ppt-hero">
        <div className="ppt-hero-shell">
          <div className="ppt-hero-copy">
            ...
            >
              <h1 className="ppt-hero-title">
                Turn Instagram <br className="ppt-hero-mobile-break" />
                DMs into
                {" "}
                <br />
            ...
            >
              <Link to="/auth" className="ppt-primary-link" aria-label="Create your PayPerTap store">
                Create your store <ArrowRight size={16} aria-hidden="true" />
              </Link>
              <Link
                to="/how-it-works"
                className="ppt-secondary-link"
                aria-label="See how PayPerTap works"
              >
      ...
      <section className="ppt-hero-answer" aria-labelledby="ppt-hero-answer-title">
