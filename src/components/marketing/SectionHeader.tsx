...
export function SectionHeader({
  ...
  return (
    <section className="ppt-page-hero relative overflow-hidden px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-14">
      ...
      <div className="relative mx-auto w-full max-w-7xl">
        <div className="max-w-4xl">
          ...
          <p className="ppt-page-subtitle ppt-home-copy mt-6 max-w-2xl text-lg leading-8">{subtitle}</p>
