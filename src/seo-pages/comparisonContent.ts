...
const commonRows = [
  ...
  },
  {
    ...
    paypertap: "Product, buyer, booking, and remaining amount context stay together.",
  },
  {
...
export const comparisonContent: Record<ComparisonSlug, ComparisonPageContent> = {
  "paypertap-vs-linktree": {
    ...
    rows: [
      ...
      },
      {
        ...
        other: "Link-first experience, not product-booking-first.",
        paypertap: "Storefront and product links built around booking intent.",
      },
      ...commonRows,
    ],
    bestFor: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. PayPerTap supports storefront and product links so buyers can see product context before booking.",
      },
    ],
    related: [
  ...
  "paypertap-vs-whatsapp-catalog": {
    ...
    rows: [
      ...
      },
      {
        ...
        paypertap: "Complements WhatsApp Business by sending booked buyers into chat with context.",
      },
      ...commonRows,
    ],
    bestFor: [
  ...
  "paypertap-vs-shopify-starter": {
    ...
    title: "PayPerTap vs Shopify Starter | Social Selling Booking Flow",
    description:
